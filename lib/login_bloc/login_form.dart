              ...
              children: <Widget>[
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    style:
                        TextStyle(fontSize: 120.0, fontWeight: FontWeight.bold,letterSpacing: 10,),
                ...
                Padding(
                  padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width/5, MediaQuery.of(context).size.width/2, MediaQuery.of(context).size.width/5, 0),
                  child: Column(
